...
<table style="width:100%; max-width: 800px; margin: 0 auto; background-color: #141321; border: 1px solid #ddd; padding: 10px; color: #ffffff;">
    ...
    <tr>
        <td>
            ...
            <img src="https://img.shields.io/badge/-Pandas-ffffff?style=flat&logo=pandas&labelColor=ffffff&color=74C488&logoColor=000000" alt="PYTHON" style="display: block; margin-bottom: 10px;">
        </td>
    </tr>
    <tr>
